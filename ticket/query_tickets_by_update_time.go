...
type QueryTicketsByUpdateTimeRequest struct {
	core.BaseRequest
	// 工单更新开始时间，例如：2018-09-18 00:00:00
	UpdateStartDatetime string `json:"update_start_datetime"`
	// 工单更新结束时间，例如：2018-09-18 23:59:59（查询创建时间段不能大于一个月）
	UpdateEndDatetime string `json:"update_end_datetime"`
...
type QueryTicketsByUpdateTimeResponse struct {
...
func (t *Ticket) QueryTicketsByUpdateTime(ctx context.Context, req *QueryTicketsByUpdateTimeRequest) (*QueryTicketsByUpdateTimeResponse, error) {
	httpReq, err := t.httpClient.NewRawRequest(ctx, http.MethodGet, "/api/ws/5/ticket/query_tickets_by_update_time", nil)
	if err != nil {
		return nil, err
	}

	var rsp QueryTicketsByUpdateTimeResponse
